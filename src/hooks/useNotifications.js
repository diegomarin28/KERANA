...
export function useNotifications() {
    ...
    const contarNoLeidas = useCallback(async () => {
        try {
            ...
            console.error('[useNotifications] Error contando:', e);
            return 0;
        }
    }, []);
    ...
    const marcarComoLeida = useCallback(async (notifId) => {
        try {
            ...
            console.error('[useNotifications] Error marcando:', e);
    ...
    const marcarTodasLeidas = useCallback(async () => {
        try {
            ...
            console.error('[useNotifications] Error marcando todas:', e);
            return { success: false, error: e.message };
        }
    }, []);
    ...
    const eliminarNotificacion = useCallback(async (notifId) => {
        try {
            ...
            console.error('[useNotifications] Error eliminando:', e);
            return { success: false, error: e.message };
        }
    }, [notificaciones]);
