            ...
            >
                ...
                <div style={{ overflowY: "auto", padding: 16, display: "grid", gap: 16 }}>
                    ...
                    <div style={{
                        ...
                        padding: 12, border: "1px solid #e5e7eb", borderRadius: 12, background: "#f9fafb"
                    }}>
                        {/* Avatar */}
                        {user?.avatarUrl ? (
                            <img src={user.avatarUrl} alt={username} style={{ width: 56, height: 56, borderRadius: "50%", objectFit: "cover" }} />
                        ) : (
                            <div style={{
                                width: 56, height: 56, borderRadius: "50%", background: "#2f6cab",
                        ...
                        <div style={{ display: "grid", alignContent: "center" }}>
                            ...
                            <div style={{ color: "#6b7280", fontSize: 12 }}>{user ? "Bienvenido/a 👋" : "Entrá para guardar tu biblioteca"}</div>
                        </div>

                        {/* Stats simples (opcional) */}
                ...
                <div style={{ padding: 12, borderTop: "1px solid #eee", color: "#6b7280", fontSize: 12 }}>
                    © {new Date().getFullYear()} UM Hub — v0.1
                </div>
            </aside>
        </>
    );
...
function NavGroup({ title, children }) {
    return (
        <div>
            <div style={{ fontSize: 12, color: "#6b7280", marginBottom: 8, textTransform: "uppercase", letterSpacing: ".04em" }}>
                {title}
            </div>
